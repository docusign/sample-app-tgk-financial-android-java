...
public class RetrieveCachedTemplateModel {
    ...
    public RetrieveCachedTemplateModel(@NonNull Status status, @Nullable DSTemplateDefinition templateDefinition, int position, @Nullable DSTemplateException exception) {
        this.status = status;
