...
public class UseTemplateOfflineModel {
    ...
    public UseTemplateOfflineModel(@NonNull Status status, @Nullable String envelopeId, @Nullable DSTemplateException exception) {
        this.status = status;
